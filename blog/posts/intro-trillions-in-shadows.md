...
summary: "Thin market friction isn't a curiosity — it's 5–10% of global GDP in missing commerce. The problem is biggest in developing economies and across borders, which is exactly where the social returns are highest. Part 2 of a 4-part series."
estimated-read: 6 min read
---

<figure class="blog-hero">
  <img class="blog-hero__img" src="../images/blog/intro-trillions-in-shadows-hero.png" alt="An iceberg with glowing commerce pathways hidden beneath the surface" loading="lazy">
...
We [estimated this sector by sector](thin-market-size.html), applying a four-factor model across the full NAICS taxonomy: sector GDP × transaction intensity × thin market fraction × AI addressability. The methodology is anchored in the transaction cost literature — Wallis and North (1988) measured total transaction costs at roughly 55% of U.S. GDP; our thin market estimate captures the subset where transactions fail entirely rather than merely costing too much.
...
*Next: [Part 3 — The Skeleton Key →](intro-skeleton-key.html)*
