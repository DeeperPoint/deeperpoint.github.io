...
The test results are recorded in a **Procedure Qualification Record (PQR)** — a legal document that certifies the welding procedure produces acceptable joints under the specified conditions. Without the PQR, Dave cannot weld the Canfor contract. Without the Canfor contract, he may have to lay off two welders for the winter.

Here is where it gets complicated.

The nearest commercial materials testing laboratory is Element Materials Technology in Richmond, BC — a suburb of Vancouver, 800 kilometres south. Dave has used them before. The process works like this: he welds the test coupons in his shop, packages them in a wooden crate, ships them by Greyhound courier or Purolator freight (two to three business days), waits for the lab to schedule the tests (one to three weeks, depending on their backlog), then waits for them to ship the results back. Total time: three to five weeks. Cost: $1,500 to $2,500 for the testing alone, plus $200-300 in shipping. If a test fails — say the root bend opens up a 4mm crack, indicating incomplete fusion at the root pass — Dave has to modify the procedure, weld new coupons, ship again, wait again. Each iteration adds another month to the timeline.

The alternative is to drive the coupons to Vancouver himself. That is a 10-hour drive each way, plus fuel, plus a night in a hotel, plus whatever the lab charges for a rush job. He has done it. Once.

Dave knows there must be testing equipment closer to Prince George. The College of New Caledonia has a welding program. UNBC has a materials science department. Thompson Rivers in Kamloops is only five hours south instead of ten. But he doesn't know whether any of these institutions have the right equipment, whether it's calibrated and accredited, whether they're allowed to do external testing, or how to even ask. He has looked at their websites. The CNC website describes a "state-of-the-art welding facility." The TRU website lists "metallurgy laboratories" under the trades program. None of them say: "We have a certified tensile testing machine available for industrial clients. Here's how to book it."
...
So the phone calls come, and Anil explains the situation, and the fabrication shop sighs and ships the coupons to Vancouver.
...
Now imagine that the **BC Manufacturing Coalition** — a consortium of the Industry Training Authority, the BC chapter of the Canadian Welding Bureau, and the BC Association of Institutes and Universities — has deployed a materials testing marketplace on MarketForge infrastructure, populated with sponsor-curated domain knowledge and designed to solve exactly this class of coordination failure.

*The people you're about to meet are real archetypes — fabricators, lab directors, welding instructors — but the specific characters, institutions, and events are fictional. This is a scenario, not a case study: a detailed illustration of what thin market automation could look like if the platform existed.*
...
Dave also shares, in a private matching layer, his budget ceiling ($1,200 — lower than Vancouver commercial rates, but he's hoping the shorter supply chain compensates), his willingness to drive the coupons to a lab within a six-hour radius rather than shipping, and his preference for a lab that can also provide metallographic examination if the bend tests show anything borderline.

---

### 2. Anil's Profile

Dr. Chandra registered his laboratory on the platform three months ago, at the suggestion of the ITA representative who visited TRU's trades campus for a program review. The platform built his lab's capability profile through a structured interview:
...
- **Calibration status**: UTM calibrated to ISO 7500-1, certificate current (expiry: November 2026). Calibration performed by Transcat Metrology, Vancouver
...
- **Geographic service area**: Kamloops hub; can receive samples by courier, Greyhound, or in-person drop-off
...
> *"A university metallurgy laboratory in Kamloops, BC, has certified testing equipment capable of performing your CSA W59 PQR test set — transverse tensile and guided bend tests. The lab is approximately 5 hours' drive from Prince George. The tensile machine is calibrated to ISO 7500-1 (certificate current). The lab supervisor has 18 years of welding metallurgy experience. Estimated turnaround: 3–5 business days from sample receipt. Estimated cost: $600–$900 for the full test set. Note: because the lab is not ISO/IEC 17025 accredited, CWB requires that a certified welding inspector witness the tests. As a CWB-certified inspector, you can fulfill this role by attending the testing session in person."*

Anil sees:

> *"A fabrication shop in Prince George, BC, needs a CSA W59 PQR test set — transverse tensile (2 specimens) and guided bend tests (4 specimens, face and root) on ASTM A106 Grade B carbon steel pipe coupons. E7018 SMAW, 6G position. The requester has coupons ready and is willing to drive to your facility. Timeline: results needed within 14 days. The requester is a CWB-certified welding inspector who can witness the testing, satisfying the alternative supervision requirement for non-17025 labs."*

For Dave, the key number is $600–$900 — less than half what Vancouver charges, and he can drive there and back in a day instead of waiting weeks. For Anil, it's billable equipment hours and professional time — revenue that justifies the university's investment and demonstrates the "industry engagement" his administration has been requesting.

---

### 4. What the Platform Knows

When the BC Manufacturing Coalition configured the platform, they populated the **Knowledge Slot** with domain-specific reference material curated by the CWB and the ITA:
...
- **Liability and insurance guidance**: the BC Manufacturing Coalition's group professional liability insurance policy, which covers participant labs performing testing within the platform's documented scope and chain of custody — addressing the specific insurance gap that had previously prevented university labs from accepting external work

The Knowledge Slot surfaces the insurance detail proactively when Anil reviews the match. This solves his second problem — the institutional barrier that previously made him decline external testing requests. Under the Coalition's umbrella policy, his lab is covered for testing performed within the platform's documented procedure. The university's risk management office has approved the arrangement.

---

### 5. The Testing Day

Dave loads six test coupons — two tensile blanks and four bend specimens, machined and etched at his shop per ASTM specifications — into a padded shipping crate and drives south on Highway 97. He leaves Prince George at 5:30 AM, stops for coffee in 100 Mile House, and arrives at the TRU trades campus in Kamloops by 10:30 AM.
...
He would not have the documentation for another three weeks if he had used Vancouver.
...
**Opacity** — Dave's testing capacity was 500 kilometres away and completely invisible to him. Anil's lab was available and capable but had no mechanism to advertise its availability to industrial clients. No directory of available testing capacity at Canadian universities and colleges exists. These institutions do not market their lab capabilities to external clients — not because they don't want to, but because they have no sales infrastructure, no standard pricing model, and no way to manage the liability. The platform's semantic matching — evaluating whether specific equipment, calibration status, and personnel qualifications satisfy specific testing requirements — makes discovery possible.

**Geographic distance** — Rural manufacturers and testing facilities are scattered across vast distances in British Columbia's interior. Dave's shop is in Prince George; the nearest commercial lab is in Vancouver. But Anil's lab is in Kamloops — less than half the distance, and reachable for a same-day round trip. The market isn't thin because testing capacity doesn't exist regionally. It's thin because neither side can see what's within economical range.
...
**Temporal distance** — Testing needs arise unpredictably. Dave didn't know he needed this PQR until the Canfor contract materialized. Lab capacity fluctuates with academic schedules — Anil's lab is busiest during exam periods and emptiest during breaks, the opposite of when industrial demand peaks. The platform's matching engine accounts for this temporal mismatch, surfacing available capacity when demand appears and letting Anil define his availability windows around the academic calendar.

**Cold start** — Neither supply (lab capacity) nor demand (testing needs) was aggregated in any accessible format before the platform existed. Individual fabrication shops had individual frustrations. Individual labs had individual idle equipment. No single entity had the incentive or the reach to aggregate both sides — until the BC Manufacturing Coalition created the institutional framework and the platform provided the matching infrastructure.

---

### 7. The Aggregation Effect

Dave's was the first test. It won't be the last.

The platform registers that the Kamloops-Prince George corridor produced a completed transaction. Anil's profile now includes a verified, witnessed PQR test set — a credential that positions his lab for future matches. Dave's profile carries a verified testing history — a signal that he is a real, active industrial client, not a cold inquiry.

Within two months, five more fabrication shops across BC's interior have registered testing needs on the platform. A structural steel shop in Williams Lake needs Charpy V-notch impact testing for a bridge project. A pressure vessel fabricator in Quesnel needs hardness testing across a dissimilar metal weld. A mining equipment repair shop in Smithers needs a welder performance qualification — essentially the same PQR process, but testing the welder rather than the procedure.

Individually, each shop generates two or three testing orders per year. Intermittent. Unpredictable. Too small and too infrequent for any single lab to build a business around.

But the platform aggregates them. Across 15 fabrication shops within a 400-kilometre radius of Kamloops, the combined testing demand is 35 to 40 orders per year — approximately three per month. That is enough to justify Anil dedicating one lab day per week to external testing, enough to cover his operating costs and generate modest revenue for the university, and enough to justify the Coalition's umbrella insurance policy.

The platform also discovers a second lab. The College of New Caledonia in Prince George — Dave's own city — has a Instron 600kN testing machine in its trades building. The welding instructor, Jean-François Bouchard, has been doing informal testing for a few local shops under the table for years, with no documentation, no chain of custody, and no insurance. He registers on the platform, uploads his calibration certificates, and suddenly the shops in the Cariboo and Peace River regions have testing capacity within same-day driving distance.

The geography of the testing market shifts. Instead of a single thick node in Vancouver and a desert everywhere else, the platform reveals a network of capable laboratories — Kamloops, Prince George, Kelowna (UBC Okanagan), Nanaimo (Vancouver Island University), Trail (Teck's metallurgical lab, with spare capacity on off-shift hours) — each with specific capabilities, specific availability windows, and specific geographic service areas.

No single lab serves the entire province. But the network, aggregated and made visible through the platform, covers most of it. The dead zones — regions with no testing capacity within economical range — become visible too, and they inform the Coalition's decisions about where to invest in new capability: perhaps a portable hardness testing kit for a college program in Fort St. John, or a partnership with a mining company in Kitimat that has an underutilized materials lab.

---

*The story of Dave and Anil is fictional — an imagined scenario, not a description of an existing platform or real participants. But the testing requirements, the accreditation frameworks, the cost structures, and the geographic realities of rural manufacturing in British Columbia are real. The thin market forces — opacity, geographic dispersion, temporal mismatch, and institutional trust barriers — are documented in the [DeeperPoint thin market framework](../thin-markets.html). The platform architecture (Cosolvent, KnowledgeSlot) is under active development. This post illustrates the kind of application a manufacturing coalition, a provincial industry training authority, or a welding industry association could build using those tools. The operational details — which standards to reference, how to structure liability coverage for academic labs doing industrial work, how to manage calibration verification across a distributed lab network — are rightly the work of a sponsor embedded in the specific context. The platform provides the matching infrastructure and the domain knowledge layer; the context is always local.*
