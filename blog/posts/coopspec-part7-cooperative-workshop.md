...
series-position: 7
title: "Workshop Notes: The Cooperative Workshop — A Word Picture"
date: 2026-03-22
...
## A Wednesday Morning in Southern Ontario
...
*(This concludes Series 4: Cooperative Specialization. The technical infrastructure that underlies this vision is described in [the DeeperPoint thin market framework →](https://deeperpoint.com/thin-markets.html) and [the MarketForge platform →](https://deeperpoint.com/marketforge.html). The open Cosolvent protocol is available at [github.com/DeeperPoint/Cosolvent →](https://github.com/DeeperPoint/Cosolvent).)*
