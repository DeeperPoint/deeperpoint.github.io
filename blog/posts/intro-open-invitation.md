...
Fifty years of cross-domain engineering experience. A working R&D prototype with [published roadmaps](../marketforge.html) for each component. A rigorous analytical framework grounded in the transaction cost literature. An open-source codebase. A growing body of [published analysis](index.html) — twelve posts and counting — that demonstrates the framework on real markets. And a concrete demonstration milestone on the horizon: **GPSim**, a market simulator modelling the Canadian specialty grain-to-Asia scenario end to end, currently well into development.
